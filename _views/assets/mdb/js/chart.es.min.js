...
class Ll {
  constructor() {
    this._controllers = new Fe(ot, "datasets", !0), this.elements = new Fe(rt, "elements"), this.plugins = new Fe(Object, "plugins"), this.scales = new Fe(Ft, "scales"), this._typedRegistries = [this._controllers, this.scales, this.elements];
  }
  add(...t) {
  ...
  add_controllers(...t) {
    this._each("register", t, this._controllers);
  }
  addElements(...t) {
  ...
  getController(t) {
    return this._get(t, this._controllers, "controller");
  }
  getElement(t) {
  ...
  remove_controllers(...t) {
    this._each("unregister", t, this._controllers);
  }
  removeElements(...t) {
...
let me = class {
  ...
  update(t) {
    ...
    if (this._updateScales(), this._checkEventBindings(), this._updateHiddenIndices(), this._plugins.invalidate(), this.notifyPlugins("beforeUpdate", { mode: t, cancelable: !0 }) === !1)
      return;
    const o = this.buildOrUpdate_controllers();
